const mapData = {
  "nodes": [
    ...
    {
      "id": 3,
      "label": "Localizada e circunscrita (sinal de torres-homem)",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 20,
      "label": "Sinal de troisier (linfonodo de virchow)",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 54,
      "label": "Sinal de rovsing",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 55,
      "label": "Sinal do psoas",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 56,
      "label": "Sinal do obturador",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 57,
      "label": "Sinal de lenander",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 77,
      "label": "Duodenal (atenuada ao comer, noturna)",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 88,
      "label": "Aumento do peristaltismo e rha",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 122,
      "label": "Rha inicialmente aumentados e depois ausentes",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 126,
      "label": "Dor aguda intensa em punhalada",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 136,
      "label": "Macicez localizada",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 137,
      "label": "Afilamento das fezes",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 139,
      "label": "Sinais de hiperesplenismo",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 140,
      "label": "Palidez de mucosas",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 142,
      "label": "Achado laboratorial associado a hiperesplenismo (com esplenomegalia)",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 146,
      "label": "Associada a hiperesplenismo",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 160,
      "label": "Esplenomegalia associada a anemia",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 177,
      "label": "Aneurisma de aorta abdominal (e Ruptura)",
      "group": "disease",
      "shape": "dot",
      "size": 30
    },
    ...
    {
      "id": 197,
      "label": "Sopro abdominal",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 198,
      "label": "Defesa sem blumberg",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 202,
      "label": "Sinal de cullen",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 203,
      "label": "Sinal de grey-turner",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 236,
      "label": "Abaulamento doloroso de fundo de saco (toque vaginal doloroso)",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 240,
      "label": "Sinal de lafont (ombro)",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 241,
      "label": "Cisto ovariano roto",
      "group": "disease",
      "shape": "dot",
      "size": 30
    },
    ...
    {
      "id": 254,
      "label": "Abaulamento umbilical",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 255,
      "label": "Macicez nos flancos com timpanismo central",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 256,
      "label": "Sinal de piparote",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 261,
      "label": "Abdome escavado",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 262,
      "label": "Perda de massa e tecido adiposo",
      "group": "symptom",
      "shape": "box"
    },
    {
    ...
    {
      "id": 275,
      "label": "Abdome protuberante ou em avental",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 276,
      "label": "Umbigo central e afundado",
      "group": "symptom",
      "shape": "box"
    },
    {
      "id": 277,
      "label": "Timpanismo normal",
      "group": "symptom",
      "shape": "box"
    },
    {
